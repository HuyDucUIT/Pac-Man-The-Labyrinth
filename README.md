...
2. [Hệ thống Giác quan của Ghost (AI)](#2-hệ-thống-giác-quan-của-Ghost-ai)
...
## 2. HỆ THỐNG GIÁC QUAN CỦA Ghost
...
* **Màn 1:** Ghost chỉ có thể đi lang thang vô định (`ROAM`).
* **Màn 2:** Có khả năng Nghe.
* **Màn 3:** Khả năng Nghe + Nhìn.
* **Màn 4:** Nghe + Nhìn + Ngửi + Xuất hiện 2 Ghost cùng lúc.

### Thông số Giác quan (Sensory Stats)
| Giác quan | Bán kính kích hoạt | Cơ chế hoạt động (State Machine) |
| :--- | :--- | :--- |
| 👂 **Nghe (Hear)** | **10 Tiles** (Hạt)<br>**Toàn bản đồ** (Cần gạt/Nút) | Khi có tiếng động, Ghost lưu "Last Known Location" và tới kiểm tra (`INVESTIGATE`). Tới nơi không thấy ai sẽ đi lang thang (`ROAM`). |
...
Nhiệm vụ của người chơi là nhặt 4 vật phẩm đặc biệt (Artifacts) ở 4 góc bản đồ và mang về bàn thờ trung tâm. Mỗi lần đặt thành công 1 vật phẩm, Ghost sẽ được "tiến hóa" (Buff):
...
Tốc độ cơ bản của Pac-Man là **2.3 px/frame** (Chậm hơn Ghost). Tầm nhìn cơ bản của Nến là **6 Tiles**. Người chơi phải mạo hiểm đi nhặt hạt tiền (phát ra tiếng ồn) để lấy xu nâng cấp trong Cửa hàng (xuất hiện qua Cánh cửa Gỗ ở hành lang an toàn).
...
| 👟 **Tốc độ Cấp 2** | Tăng lên **3.45 px/frame** (~ Bằng Ghost) | 1 | **140 xu** |
| 👟 **Tốc độ Cấp 3** | Tăng lên **4.025 px/frame** (Nhanh hơn Ghost) | 1 | **190 xu** |
...
| 🥷 **Khử mùi (Stealth)**| Bán kính ngửi của Ghost bị giảm còn **80%** | 1 | **150 xu** |
