...
* **Tiến trình tuyến tính:** Game gồm 4 căn phòng tiêu chuẩn (Màn 1 -> Màn 4) và 1 phòng Boss (Màn 5). Người chơi phải tìm và kích hoạt đủ số lượng Cần gạt / Nút bấm theo yêu cầu để mở Cửa Xanh qua phòng tiếp theo. Không thể quay lại phòng cũ (No Backtracking).
...
* **Kinh tế (Dot Economy):** Số lượng hạt tiền (Dots) tăng dần theo từng màn (30, 40, 50, 60 hạt cho các màn 1-4). 1 Hạt = 10 Xu. Tối đa kiếm được khoảng 1800 Xu trước khi bước vào màn cuối. 
* **Cơ chế Reset (Anti-Cheese):** Tính năng "Labyrinth Mode" hoặc bấm nút ESC thoát về Menu sẽ đưa người chơi về màn 1 và **Reset toàn bộ tiền xu** về 0. Nếu bị bắt chết ở các màn tiêu chuẩn, bấm SPACE sẽ cho phép hồi sinh chơi lại màn đó và giữ nguyên chỉ số nâng cấp.

---

## 2. HỆ THỐNG GIÁC QUAN CỦA BOSS (AI)
Trùm (Stalker Boss) có tốc độ di chuyển mặc định là **3.5 px/frame** và **có thể đi xuyên tường** khi rơi vào trạng thái truy đuổi (`CHASE`). Thử thách tăng dần qua từng màn:
...
| 👃 **Ngửi (Smell)**| **3.5 Tiles** | Dù Pac-man có trốn trong bóng tối tuyệt đối, nếu Boss đi tuần ngang qua sát vách (3.5 ô), nó sẽ đánh hơi thấy (`SMELL_SEARCH`), lùng sục quanh khu vực đó trong 1 khoảng thời gian. |
...
* **Vật 1:** Mở khóa khả năng **Nghe** và **Ngửi**.
* **Vật 2:** Mở khóa khả năng **Nhìn**.
* **Vật 3:** Kỹ năng **Nhân bản** - Triệu hồi thêm Boss thứ 2.
* **Vật 4:** Khóa toàn bộ cửa phòng trung tâm, tốc độ Boss bị giảm xuống 75%. Người chơi phải **sống sót sinh tồn trong 30 giây** để giành chiến thắng.
